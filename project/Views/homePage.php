    ...
    <div class="row">
        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <a id="favoriteStreamerButton" class="btn btn-outline-secondary" href="#" role="button">Streamer page</a>
<!--                <button class="btn btn-outline-secondary" type="button" href="--><?//= $data['href'] ?? '' ?><!--" >Streamer page</button>-->
            </div>
